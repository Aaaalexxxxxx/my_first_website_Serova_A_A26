      ...
      <div class="container">
        <div class="row">
          ...
          <form method="POST" action="registration.php">
            ...
            <div class="form_reg"><input class="form" type="text" name="login" placeholder="Your login"></div>
            <div class="form_reg"><input class="form" type="password" name="password" placeholder="Your password"></div>

            <button class="btn_continue"  type="submit" name="submit">Продолжить</button>
	        </form>
        </div>
      </div>
    </body>
